...
export default {
    data() {
        return {
            ...
            productDialog: false,
            editedIndex: -1,
            editedPayments: null, // Inicialmente nulo para evitar erros de acesso
            defaultProduct: {
                id: null,
                payment_type: "",
                category_id: null,
    ...
    computed: {
        ...
        // },
        // subcategories() {
        //     if (!this.editedPayments || !this.editedPayments.category_id) return [];
        //     return this.categories.filter((c) => c.is_subcategory && c.parent_id === this.editedPayments.category_id);
        // },
        // formTitle() {
    ...
    methods: {
        ...
        // },
        // editProduct(item) {
        //     this.editedIndex = this.payments.findIndex((p) => p.id === item.id);
